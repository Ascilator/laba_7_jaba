...
public class Main extends JFrame implements ActionListener {
    ...
    public Main(String title) {
        super(title);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // cross

        drawPanel = new DrawCanvas(); //create canvas
        drawPanel.setPreferredSize(new Dimension(CANVAS_WIDTH, CANVAS_HEIGHT)); //init
